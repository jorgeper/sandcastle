...
Additionally, ONLY consider these issue numbers — every other issue already
has work in flight (an open PR) and must not be re-planned:

<candidate-issues>
{{CANDIDATE_NUMBERS}}
</candidate-issues>

If the candidate list is empty, output an empty plan.
